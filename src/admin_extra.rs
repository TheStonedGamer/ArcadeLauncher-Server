        ...
        <div class="admin-layout">
          ...
          <div class="content">
            ...
            <section class="section"><div class="section-heading"><h2>Create User</h2><span class="muted">Admins are created here directly; regular accounts can also self-register and be approved above.</span></div>
              <form method="post" class="row"><input type="hidden" name="return_to" value="accounts"><input name="username" placeholder="Username"><input name="email" type="email" placeholder="Email"><input name="password" type="password" placeholder="Password (10+ chars)"><label class="checkline"><input type="checkbox" name="is_admin" value="1"> Admin</label><button name="action" value="add_user">Create User</button></form>
            </section>

...
async fn admin_html(st: &AppState, admin: Option<User>, message: &str, matcher_game_id: &str, matcher_query: &str) -> Result<String> {
    ...
    let discord_app_id = settings.iter().find(|(k, _)| k == DISCORD_APP_ID_KEY).map(|(_, v)| v.as_str()).unwrap_or("");
    ...
    Ok(shell(&format!(
        ...
        <div class="admin-layout">
          <aside class="sidebar"><div class="brand-block"><div class="brand-mark">AL</div><div><div class="brand-title">ArcadeLauncher</div><div class="brand-subtitle">Rust Server</div></div></div><nav><a href="#overview">Overview</a><a href="#services">Services</a><a href="#library">Library Setup</a><a href="#changelogs">Changelogs</a><a href="/admin/metadata">Metadata</a><a href="/admin/accounts">Accounts</a><a href="/admin/requests">Game Requests</a><a href="#config">Configuration</a></nav></aside>
          <div class="content">
